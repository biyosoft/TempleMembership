...
final class PaymentTable extends PowerGridComponent
{
    ...
    */
    ...
    {
        return payment::query()->join("memberships", "memberships.id", "=", "member_id")->select("payments.*", "memberships.gvBrowseCompanyName as member_name");
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::add()
                ...
                ->field('member_name')
                ->searchable()
                ->makeInputText('member_name')
                ->sortable(),
            Column::add()
                ->title('Payment Date')
                ->field('payment_date_formatted')
                ->searchable()
                ->makeInputDatePicker('payment_date')
                ->sortable(),
